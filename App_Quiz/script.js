...
foodElement.style.width = "20%"; // 幅を50%に設定
...
choiceImage.addEventListener("mouseover", () => {
  showBalloon(choice.baloon);
});

// マウスアウト時に吹き出しを非表示
choiceImage.addEventListener("mouseout", () => {
  hideBalloon();
});
